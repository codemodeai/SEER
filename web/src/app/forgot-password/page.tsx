        ...
        <div className="max-w-sm w-full">
          ...
          {sent ? (
            <div className="text-center">
              ...
              <Link
                href="/login"
                className="mt-6 inline-flex items-center gap-2 text-sm text-terracotta hover:text-terracotta-dark font-medium"
              >
                <ArrowLeft size={14} />
                Back to login
              </Link>
            ...
            <>
              ...
              <p className="mt-6 text-center text-xs text-muted">
                <Link
                  href="/login"
                  className="inline-flex items-center gap-1.5 text-terracotta hover:text-terracotta-dark font-medium"
                >
                  <ArrowLeft size={12} />
                  Back to login
                </Link>
